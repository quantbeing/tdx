...
| Security count/list | yes | Raw/unknown fields preserved. `tdx-validate -full-security-list` pages through the complete selected-market list, emits per-page results, and checks count parity plus duplicate symbols. |
